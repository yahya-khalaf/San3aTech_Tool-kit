...
function FlowchartContent() {
    ...
    useEffect(() => {
        ...
        const reactFlowNodes: RFNode[] = Object.values(flow.nodes).map((node) => ({
            ...
            style: {
                background: node.type === 'terminal' ? '#F9DFE1' : '#FFFFFF',
                color: '#240D18',
                borderRadius: '12px',
                padding: '20px',
                fontSize: '14px',
                ...
                border: node.id === flow.startNodeId ? '3px solid #CF2027' : '1px solid #E5E7EB',
                cursor: 'pointer',
        ...
        Object.values(flow.nodes).forEach((node) => {
            node.options.forEach((option) => {
                reactFlowEdges.push({
                    ...
                    target: option.next,
                    label: option.label,
                    labelStyle: { fill: '#CF2027', fontWeight: 700, fontSize: 11 },
                    labelBgStyle: { fill: '#F9DFE1', fillOpacity: 0.9 },
    ...
    return (
        <div className="flex flex-col h-full">
            {/* Toolbar */}
            <header className="h-16 px-8 flex items-center justify-between bg-white/70 backdrop-blur-xl border-b border-white/40 z-10">
            ...
            <div className="flex-1 bg-gray-50 relative">
                ...
                >
                    ...
                    <MiniMap
                        ...
                        nodeColor={(n: any) => n.data?.type === 'terminal' ? '#CF2027' : '#E5E7EB'}
            ...
            {/* Legend */}
            <div className="absolute bottom-6 left-6 z-10 p-4 bg-white/80 backdrop-blur-xl rounded-xl border border-white/50 shadow-xl space-y-2 pointer-events-none">
